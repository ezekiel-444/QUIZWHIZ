const questions = [
     ...
     //14
    {
     ...
     //18
     {
        ...
        optionA: "Hideki Tojo was a threat to USA'S national security and should be stopped",
        optionB: "WWI had improved America's stature in the world and the nation should be a leader in future conflicts.",
        optionC: "Hitler was making reasonable requests and should be allowed to rearm his nation.",
        optionD: "WWI was fought for financial reasons and the U.S. should stay out of future foreign wars.",
        correctOption: "optionD"
     },                      
           ]
